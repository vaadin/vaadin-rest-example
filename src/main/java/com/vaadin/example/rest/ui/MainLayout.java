...
public class MainLayout extends AppLayout implements AfterNavigationObserver {
    ...
    public MainLayout() {
        ...
        final UnorderedList list = new UnorderedList(new ListItem(home), new ListItem(inMemoryDTO), new ListItem(asyncInMemoryDTO), new ListItem(inMemoryJSON),
